...
paths= f"oci://ia-visitation-data@bmmp5bv7olp2/{source.lower()}_data/hdfs_data/step_0_new/{country}/"
...
print("gdyfdgfhgukyfughjcgfdffhg")
# %%
...
def createLogs():
    ...
    # Method 1: Object.put()
        ...
        logs_path = 'logs/{0}/{2}/{3}_{1}_data_split.txt'.format(source_date, country, source, today)
...
save_string = f"oci://ia-visitation-data@bmmp5bv7olp2/lf_data/hdfs_data/{source.lower()}/parquet/step_1_new/"#f"oci://ia-visitation-data@bmmp5bv7olp2/lf_data/hdfs_data/{source.lower()}/delta/step_1/"
save_string
...
df_final_write = df_final_write.withColumn("year", df_final_write.date.substr(1,4))
# %%
start_time = time.time()
try:
